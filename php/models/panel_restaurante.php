...
<head>
    ...
    <link rel="stylesheet" href="../../css/style_panel_restaurante.css">
...
<body>
    <div class="container">
        ...
        <aside>
            ...
            <div class="sidebar">
                ...
                <a href="../views/actualizar_datos_restaurante.php">
                    <span class="material-icons-sharp">person_outline</span>
                    <h3>Perfil</h3>
                </a>
                <a href="../views/menu_restaurante.php">
                    <span class="material-icons-sharp">receipt_long</span>
                    <h3>Menu</h3>
                </a>
                <a href="../views/suscripcion.php">
            ...
            <main>
                ...
                <div class="analyse">
                    <div class="sales">
                        <div class="status">
                            <div class="info">
                                <a href="../views/premios_restaurante.php"><h3>Premios</h3></a>
                            </div>
                        </div>
                    </div>
                    <div>
    ...
    <script src="../../js/orders_restaurante.js"></script>
    <script src="../../js/panel_restaurante.js"></script>
